...
# to find the relationships between the variables, their distributions, outliers, and overall structures.
...
#sns.catplot(x="District", y="Arrest", kind="swarm", data=balti)
...
# Nested boxplot for age and Charge Description
...
#%%
# Categorical Estimate Plots: Histogram
...
#%%
# KNN Models for Top 5 Most Frequent Charges and Cateogirical Variables
...
# Train score is 59% and test score is 52%. Thus, accuracy of model is 52% , which is a decent, but could be better.
...
# Cross Val Score is 52%. Our model is 52% accurate at explaining test or "unseen" data.
